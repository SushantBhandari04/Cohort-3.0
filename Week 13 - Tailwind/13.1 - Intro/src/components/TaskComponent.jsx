function TaskComponent(){
    return <div className="grid grid-cols-2 justify-around rounded-lg items-center h-64 m-2 w-3/5 sm:w-2/6 text-sm shadow-lg  p-2 pl-4">
...
function Image({url}){
    return <>
        <img className="h-12 w-12 bg-green-300 p-2.5 rounded-md" src={url} alt="" />
    </>
}
