    ...
    return (
        <div>
            ...
            <Modal isOpen={isModalOpen} onClose={() => setModalOpen(false)}>
                <h2 style={{color: "green"}}>Modal Title</h2> {/* Render a heading element with text content */}
                <p style={{color: "green"}}>This is some content inside the modal.</p> {/* Render a paragraph element with text content */}
